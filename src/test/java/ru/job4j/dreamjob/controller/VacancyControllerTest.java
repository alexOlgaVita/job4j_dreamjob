...
class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyByIdPageThenGetPageWithCities() {
    ...
    public void whenPostUpdateVacancyWithFileThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var vacancyOld = new Vacancy(1, "test0", "desc1", now(), true, 1, 2);
        when(vacancyService.findById(vacancyOld.getId())).thenReturn(Optional.of(vacancyOld));
    ...
    @Test
    public void whenRequestDeleteVacancyByIdPageThenDeleteAndRedirectPageWithVacancies() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        when(vacancyService.findById(vacancy.getId())).thenReturn(Optional.of(vacancy));
